                    ...
                    <ul class="ztr-comment-info-items">
                      <li class="ztr-comment-info-author">
                        ...
                        <span style="white-space: nowrap;">
                          <strong> {action()}ed</strong> {createdTimeAgo()}
                        </span>
                      </li>
                ...
                <div class="ztr-comment-text">
                  ...
                  {isUnspecifiedVersion() && (
                    <p class="warning">
                      {warningSvg()}
                      <span>
                        Article contents may have changed since this {action()}{" "}
                        was made
                      </span>
                    </p>
                  )}
                  {isDifferentVersion() && (
                    <p class="warning">
                      {warningSvg()}
                      <span>
                        Article contents changed since this {action()} was made
                      </span>
                    </p>
                  )}
                </div>
